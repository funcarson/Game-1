...
draw_text(room_width/3  + 15, y + 90, string(" - Attack "));
draw_text(room_width/3  + 15, y + 110, string(" - Swap Weapon "));

//objective
draw_text(room_width/3 + 10, y + 130, string("Objective: "));
draw_text(room_width/3  + 15, y + 150, string("Survive until the printer is finished"));
